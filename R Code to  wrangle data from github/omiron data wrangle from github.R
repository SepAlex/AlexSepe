---
  title: "The Smart Group  Consortium"
...
```
### Project Name: AJA Breweries Project
### Location: Timbuktu
### Client: Budweiser Breweries
#### Project Description: Omiron Data Wrangle from Github.R
##### GitHub Repository: https://github.com/SepAlex/AlexSepe-Project-.git

```{rLoadingFiles, echo=FALSE,include=F}
library(knitr)
library(tidyverse)
library(lubridate)
library(countrycode)
