...
##### rpubs Repository: http://rpubs.com/donfila/891590
...
library(knitr)
library(ggplot2)
library(fiftystater)  #please download package from this link, file also found in our project zip file https://cran.r-project.org/src/contrib/Archive/fiftystater/fiftystater_1.0.1.tar.gz
library(mapproj)
library(tidyr)
library(grid)
library(gridExtra)
